...
vector StanevBSSMagneticField::at_position(const double &x, const double &y, const double &z) const { 
    ...
    vector B_cyl{{B_0 * cos(phi_prime - beta * log(r/b_r0)) * sin(b_p*(M_PI/180.)) * exp(-std::abs(z)/b_z0),
