...
//  JF12MagneticField &operator=(JF12MagneticField &&) = delete;
  ...
  const double b_arm_1 = 0.1;
  const double b_arm_2 = 3.0;
  const double b_arm_3 = -0.9;
  const double b_arm_4 = -0.8;
  const double b_arm_5 = -2.0;
  const double b_arm_6 = -4.2;
  const double b_arm_7 = 0.0;
  const double b_ring = 0.1;
  const double h_disk = 0.40;
  const double w_disk = 0.27;

                      // toroidal halo parameters
  const double Bn = 1.4;
  const double Bs = -1.1;
  const double rn = 9.22;
  const double rs = 16.7;
  const double wh = 0.20;
  const double z0 = 5.3;

                      // X-field parameters
  const double B0_X = 4.6;
  const double Xtheta_const = 49;
  const double rpc_X = 4.8;
  const double r0_X= 2.9;
